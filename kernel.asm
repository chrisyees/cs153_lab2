...
80106cf5:	83 ec 20             	sub    $0x20,%esp
...
//you write this
	...
	int x;
	acquire(&(shm_table.lock));
80106cfb:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d02:	e8 49 d4 ff ff       	call   80104150 <acquire>
80106d07:	ba f4 54 11 80       	mov    $0x801154f4,%edx
	for(i = 0; i < 64; i++)
80106d0c:	31 c0                	xor    %eax,%eax
80106d0e:	eb 0f                	jmp    80106d1f <shm_open+0x2f>
80106d10:	83 c0 01             	add    $0x1,%eax
80106d13:	83 c2 0c             	add    $0xc,%edx
80106d16:	83 f8 40             	cmp    $0x40,%eax
80106d19:	0f 84 91 00 00 00    	je     80106db0 <shm_open+0xc0>
	{
		if(shm_table.shm_pages[i].id == id)
80106d1f:	39 1a                	cmp    %ebx,(%edx)
80106d21:	75 ed                	jne    80106d10 <shm_open+0x20>
		{
			//panic("not first to enter");
			shm_table.shm_pages[i].refcnt++;
80106d23:	8d 04 40             	lea    (%eax,%eax,2),%eax
80106d26:	c1 e0 02             	shl    $0x2,%eax
			x = mappages(myproc()->pgdir, (char*)PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106d29:	8b b0 f8 54 11 80    	mov    -0x7feeab08(%eax),%esi
	for(i = 0; i < 64; i++)
	{
		if(shm_table.shm_pages[i].id == id)
		{
			//panic("not first to enter");
			shm_table.shm_pages[i].refcnt++;
80106d2f:	83 80 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%eax)
			x = mappages(myproc()->pgdir, (char*)PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106d36:	81 c6 00 00 00 80    	add    $0x80000000,%esi
		{
		//	panic("first to enter");
			...
			x = mappages(myproc()->pgdir, (char*)PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106d3c:	e8 6f c9 ff ff       	call   801036b0 <myproc>
80106d41:	8b 18                	mov    (%eax),%ebx
80106d43:	e8 68 c9 ff ff       	call   801036b0 <myproc>
80106d48:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106d4c:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d53:	00 
80106d54:	81 c3 ff 0f 00 00    	add    $0xfff,%ebx
80106d5a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106d60:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106d64:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d6b:	00 
...
80106d79:	e8 32 c9 ff ff       	call   801036b0 <myproc>
80106d7e:	8b 10                	mov    (%eax),%edx
80106d80:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d83:	81 c2 ff 0f 00 00    	add    $0xfff,%edx
80106d89:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106d8f:	89 10                	mov    %edx,(%eax)
			myproc()->sz++;
80106d91:	e8 1a c9 ff ff       	call   801036b0 <myproc>
80106d96:	83 00 01             	addl   $0x1,(%eax)
			release(&(shm_table.lock));
...
80106db0:	ba fc 54 11 80       	mov    $0x801154fc,%edx
//you write this
	...
	acquire(&(shm_table.lock));
	for(i = 0; i < 64; i++)
80106db5:	30 c0                	xor    %al,%al
80106db7:	eb 12                	jmp    80106dcb <shm_open+0xdb>
80106db9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	...
	for(i = 0; i < 64; i++)
80106dc0:	83 c0 01             	add    $0x1,%eax
80106dc3:	83 c2 0c             	add    $0xc,%edx
80106dc6:	83 f8 40             	cmp    $0x40,%eax
80106dc9:	74 32                	je     80106dfd <shm_open+0x10d>
	{
		if(shm_table.shm_pages[i].refcnt == 0) //find empty entry
80106dcb:	8b 0a                	mov    (%edx),%ecx
80106dcd:	85 c9                	test   %ecx,%ecx
80106dcf:	75 ef                	jne    80106dc0 <shm_open+0xd0>
		{
		//	panic("first to enter");
			shm_table.shm_pages[i].id = id;
80106dd1:	8d 34 40             	lea    (%eax,%eax,2),%esi
80106dd4:	c1 e6 02             	shl    $0x2,%esi
80106dd7:	89 9e f4 54 11 80    	mov    %ebx,-0x7feeab0c(%esi)
			shm_table.shm_pages[i].frame = kalloc();
80106ddd:	e8 ce b6 ff ff       	call   801024b0 <kalloc>
			shm_table.shm_pages[i].refcnt = 1;
80106de2:	c7 86 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%esi)
80106de9:	00 00 00 
	{
		if(shm_table.shm_pages[i].refcnt == 0) //find empty entry
		{
		//	panic("first to enter");
			shm_table.shm_pages[i].id = id;
			shm_table.shm_pages[i].frame = kalloc();
80106dec:	89 86 f8 54 11 80    	mov    %eax,-0x7feeab08(%esi)
			shm_table.shm_pages[i].refcnt = 1;
			x = mappages(myproc()->pgdir, (char*)PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106df2:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
80106df8:	e9 3f ff ff ff       	jmp    80106d3c <shm_open+0x4c>
			release(&(shm_table.lock));
			return x;
		}
	}		
...
release(&(shm_table.lock));
80106dfd:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e04:	e8 37 d4 ff ff       	call   80104240 <release>
panic("Help shm failed");
80106e09:	c7 04 24 bd 78 10 80 	movl   $0x801078bd,(%esp)
80106e10:	e8 4b 95 ff ff       	call   80100360 <panic>
80106e15:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106e36:	ba f4 54 11 80       	mov    $0x801154f4,%edx
	for(i = 0; i < 64; i++)
80106e3b:	31 c0                	xor    %eax,%eax
80106e3d:	eb 0c                	jmp    80106e4b <shm_close+0x2b>
80106e3f:	90                   	nop
80106e40:	83 c0 01             	add    $0x1,%eax
80106e43:	83 c2 0c             	add    $0xc,%edx
80106e46:	83 f8 40             	cmp    $0x40,%eax
80106e49:	74 25                	je     80106e70 <shm_close+0x50>
	{
		if(shm_table.shm_pages[i].id == id)
80106e4b:	39 1a                	cmp    %ebx,(%edx)
80106e4d:	75 f1                	jne    80106e40 <shm_close+0x20>
		{
			shm_table.shm_pages[i].refcnt--;
80106e4f:	8d 04 40             	lea    (%eax,%eax,2),%eax
80106e52:	8d 14 85 cc 54 11 80 	lea    -0x7feeab34(,%eax,4),%edx
80106e59:	8b 42 30             	mov    0x30(%edx),%eax
...
80106e5f:	85 c0                	test   %eax,%eax
	...
	for(i = 0; i < 64; i++)
	{
		...
		{
			shm_table.shm_pages[i].refcnt--;
80106e61:	89 42 30             	mov    %eax,0x30(%edx)
			if(shm_table.shm_pages[i].refcnt == 0)
80106e64:	74 22                	je     80106e88 <shm_close+0x68>
	}
...
release(&(shm_table.lock));
80106e70:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e77:	e8 c4 d3 ff ff       	call   80104240 <release>
return 1 ; //added to remove compiler warning -- you should decide what to return
}
80106e7c:	83 c4 14             	add    $0x14,%esp
		}
	}
...
release(&(shm_table.lock));
return 1 ; //added to remove compiler warning -- you should decide what to return
80106e7f:	b8 01 00 00 00       	mov    $0x1,%eax
}
80106e84:	5b                   	pop    %ebx
80106e85:	5d                   	pop    %ebp
80106e86:	c3                   	ret    
80106e87:	90                   	nop
		if(shm_table.shm_pages[i].id == id)
		{
			...
			{
				release(&(shm_table.lock));
80106e88:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e8f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106e92:	e8 a9 d3 ff ff       	call   80104240 <release>
				shminit();	
80106e97:	e8 f4 fd ff ff       	call   80106c90 <shminit>
...
80106e9f:	83 c4 14             	add    $0x14,%esp
80106ea2:	5b                   	pop    %ebx
80106ea3:	5d                   	pop    %ebp
80106ea4:	c3                   	ret    
