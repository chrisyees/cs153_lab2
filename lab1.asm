...
int main(int argc, char *argv[])
{
    ...
    1012:	e8 c9 02 00 00       	call   12e0 <atoi>
	x = fib(x);
    1017:	89 04 24             	mov    %eax,(%esp)
    101a:	e8 21 00 00 00       	call   1040 <fib>
	printf(1,"\nResult: %d\n", x);
    101f:	c7 44 24 04 45 18 00 	movl   $0x1845,0x4(%esp)
    1026:	00 
    1027:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    102e:	89 44 24 08          	mov    %eax,0x8(%esp)
    1032:	e8 69 04 00 00       	call   14a0 <printf>
	exit();
    1037:	e8 06 03 00 00       	call   1342 <exit>
...
int fib(int x) {
    ...
    104e:	0f 84 7c 00 00 00    	je     10d0 <fib+0x90>
		return 0;
	if(x == 1)
    1054:	83 fb 01             	cmp    $0x1,%ebx
    1057:	0f 84 a7 00 00 00    	je     1104 <fib+0xc4>
		return 1;
	if(x == 2)
    105d:	83 fb 02             	cmp    $0x2,%ebx
    1060:	0f 84 97 00 00 00    	je     10fd <fib+0xbd>
		return 2;
	if(x == 3)
    1066:	83 fb 03             	cmp    $0x3,%ebx
    1069:	0f 84 9c 00 00 00    	je     110b <fib+0xcb>
    106f:	bf 01 00 00 00       	mov    $0x1,%edi
    1074:	eb 11                	jmp    1087 <fib+0x47>
...
int fib(int x) {
	if(x == 0)
		return 0;
	if(x == 1)
    1078:	83 fb 01             	cmp    $0x1,%ebx
    107b:	74 55                	je     10d2 <fib+0x92>
		return 1;
	if(x == 2)
    107d:	83 fb 02             	cmp    $0x2,%ebx
    1080:	74 5e                	je     10e0 <fib+0xa0>
		return 2;
	if(x == 3)
    1082:	83 fb 03             	cmp    $0x3,%ebx
    1085:	74 69                	je     10f0 <fib+0xb0>
		return 3;
        printf(1,"\n%d",x);
    1087:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    108b:	c7 44 24 04 41 18 00 	movl   $0x1841,0x4(%esp)
    1092:	00 
    1093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    109a:	e8 01 04 00 00       	call   14a0 <printf>
    109f:	8d 43 ff             	lea    -0x1(%ebx),%eax
	return fib(x - 1) * fib(x - 2) * fib(x - 3) * fib(x - 4);
    10a2:	89 04 24             	mov    %eax,(%esp)
    10a5:	e8 96 ff ff ff       	call   1040 <fib>
    10aa:	89 c6                	mov    %eax,%esi
    10ac:	8d 43 fe             	lea    -0x2(%ebx),%eax
    10af:	89 04 24             	mov    %eax,(%esp)
    10b2:	e8 89 ff ff ff       	call   1040 <fib>
    10b7:	0f af f0             	imul   %eax,%esi
    10ba:	8d 43 fd             	lea    -0x3(%ebx),%eax
    10bd:	89 04 24             	mov    %eax,(%esp)
    10c0:	e8 7b ff ff ff       	call   1040 <fib>
    10c5:	0f af f0             	imul   %eax,%esi
    10c8:	0f af fe             	imul   %esi,%edi
#include "types.h"
#include "user.h"

int fib(int x) {
	if(x == 0)
    10cb:	83 eb 04             	sub    $0x4,%ebx
    10ce:	75 a8                	jne    1078 <fib+0x38>
    ...
    10e3:	01 ff                	add    %edi,%edi
    10e5:	5b                   	pop    %ebx
    10e6:	89 f8                	mov    %edi,%eax
    10e8:	5e                   	pop    %esi
    10e9:	5f                   	pop    %edi
    10ea:	5d                   	pop    %ebp
    10eb:	c3                   	ret    
    10ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    10f0:	83 c4 1c             	add    $0x1c,%esp
    10f3:	8d 3c 7f             	lea    (%edi,%edi,2),%edi
    10f6:	5b                   	pop    %ebx
    10f7:	89 f8                	mov    %edi,%eax
    10f9:	5e                   	pop    %esi
    10fa:	5f                   	pop    %edi
    10fb:	5d                   	pop    %ebp
    10fc:	c3                   	ret    
int fib(int x) {
	...
	if(x == 1)
		return 1;
	if(x == 2)
    10fd:	bf 02 00 00 00       	mov    $0x2,%edi
    1102:	eb ce                	jmp    10d2 <fib+0x92>
#include "user.h"
...
int fib(int x) {
    ...
    1109:	eb c7                	jmp    10d2 <fib+0x92>
		return 1;
	if(x == 2)
		return 2;
	if(x == 3)
    110b:	bf 03 00 00 00       	mov    $0x3,%edi
    1110:	eb c0                	jmp    10d2 <fib+0x92>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1439:	0f b6 92 59 18 00 00 	movzbl 0x1859(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    15cf:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
    15d1:	b8 52 18 00 00       	mov    $0x1852,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1691:	a1 5c 1b 00 00       	mov    0x1b5c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    16d9:	a3 5c 1b 00 00       	mov    %eax,0x1b5c
}
    16de:	5b                   	pop    %ebx
    16df:	5e                   	pop    %esi
    16e0:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    1702:	a3 5c 1b 00 00       	mov    %eax,0x1b5c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    172c:	8b 1d 5c 1b 00 00    	mov    0x1b5c,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    176b:	3b 15 5c 1b 00 00    	cmp    0x1b5c,%edx
...
morecore(uint nu)
{
  ...
  return freep;
    17a2:	8b 15 5c 1b 00 00    	mov    0x1b5c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17c4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
    17c7:	89 15 5c 1b 00 00    	mov    %edx,0x1b5c
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    17de:	c7 05 5c 1b 00 00 60 	movl   $0x1b60,0x1b5c
    17e5:	1b 00 00 
    base.s.size = 0;
    17e8:	ba 60 1b 00 00       	mov    $0x1b60,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    17ed:	c7 05 60 1b 00 00 60 	movl   $0x1b60,0x1b60
    17f4:	1b 00 00 
    base.s.size = 0;
    17f7:	c7 05 64 1b 00 00 00 	movl   $0x0,0x1b64
    17fe:	00 00 00 
